...
export default function MarkdownViewer() {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0">
      ...
      <div className="flex-1 flex gap-0 min-h-0 border border-gray-800 rounded-lg overflow-hidden bg-gray-950">
        {!previewOnly && (
          <>
        ...
        <div className="flex-1 flex flex-col min-w-0 min-h-0 overflow-hidden">
          ...
          <div className="flex-1 min-h-0 p-4 overflow-auto prose prose-invert prose-sm max-w-none prose-headings:text-gray-200 prose-p:text-gray-300 prose-code:text-gray-200 prose-pre:bg-gray-800 prose-li:text-gray-300 prose-blockquote:text-gray-400 prose-table:text-gray-300 prose-th:border prose-th:border-gray-600 prose-th:bg-gray-800 prose-th:px-3 prose-th:py-2 prose-td:border prose-td:border-gray-600 prose-td:px-3 prose-td:py-2">
            {markdown.trim() ? (
              <ReactMarkdown
